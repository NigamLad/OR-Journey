        ...
        <div ref="eventBody" id="eventBody" class="Collapsed">
            <div class="overflow-hidden">
                <div class="px-1 py-2">
                    ...
                    <img v-if="event.image" :src="baseURL + '/mock-user-data/images/' + event.image">
                    <video v-if="event.video" controls muted><source :src="'/mock-user-data/videos/' + event.video"></video>
                </div>
                <p class="float-right">
                    {{
